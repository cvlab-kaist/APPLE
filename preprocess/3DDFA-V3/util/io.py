...
class visualize:
    ...
    def visualize_ldm68(self, trans_params, img, save_path, img_name):
        ...
        img_ldm68 = plot_kpts(np.zeros_like(img), ldm68)
        # np.save(os.path.join(save_path, img_name + '_ldm68.npy'), ldm68)
        os.makedirs(save_path, exist_ok=True)
        cv2.imwrite(os.path.join(save_path, img_name + '_ldm68.png'), img_ldm68)
        print('ldm68 saved to {}'.format(os.path.join(save_path, img_name + '_ldm68.png')))
